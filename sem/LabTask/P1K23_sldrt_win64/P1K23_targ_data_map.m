  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P1K23_P.PIDController1_D
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P1K23_P.PIDController_D
	  ...
	  ;% P1K23_P.PIDController_I
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P1K23_P.PIDController1_InitialConditionForFilter
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P1K23_P.PIDController_InitialConditionForFilter
	  ...
	  ;% P1K23_P.PIDController_N
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 13;
	
	  ;% P1K23_P.PIDController1_P
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
	
	  ;% P1K23_P.PIDController_P
	  ...
	  ;% P1K23_P.Step3_YFinal
	  section.data(3).logicalSrcIdx = 27;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P1K23_P.TransportDelay_Delay
	  ...
	  ;% P1K23_P.ManualSwitch_CurrentSetting
	  section.data(1).logicalSrcIdx = 37;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P1K23_P.ManualSwitch1_CurrentSetting
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P1K23_B.ProportionalGain
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P1K23_B.DerivativeGain
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P1K23_B.FilterCoefficient
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	  ...
	  ;% P1K23_B.ProportionalGain_m
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P1K23_B.DerivativeGain_l
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 7;
	
	  ;% P1K23_B.FilterCoefficient_g
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 8;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P1K23_DW.TransportDelay_RWORK.modelTStart
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% P1K23_DW.TransportDelay_PWORK.TUbufferPtrs
	  ...
	  ;% P1K23_DW.angle_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 4;
	  section.data(4).dtTransOffset = 4;
	
	  ;% P1K23_DW.motorvoltage_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 5;
	  section.data(5).dtTransOffset = 5;
	
	  ;% P1K23_DW.position_PWORK.LoggedData
  ...
  targMap.checksum0 = 3511948149;
  targMap.checksum1 = 2600440148;
  targMap.checksum2 = 4234720960;
  targMap.checksum3 = 3465127016;
