...
g = 9.80665;       % [m/s^2]
M = 0.55;           % [kg] cart mass
m = 0.157;         % [kg] pendulum mass
l = 0.11;           % [m] pendulum length
lcm = 0.043;        % [m] pendulem lenght to center of mass
T = 0.58;
omega = 2*pi/T;
...
vmax = 0.56;
kf = b*vmax/0.4;          % [N/V] input voltage to force ratio
...
K_I_down = K_sloz_down(5);

disp('Nové K (pro stavy):'); disp(K_new_down);
