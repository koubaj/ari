...
MAKECMD         = "C:/MATLAB/R2021a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := pid_pos
MODULES              := pid_pos_data.c pid_pos_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := pid_pos.mk
...
SLDRTDIR             := C:/MATLAB/R2021a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := pid_pos_ref.rsp
...
# additional includes
REQ_INCLUDES += ;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask/pid_pos_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
