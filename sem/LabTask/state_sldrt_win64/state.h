...
#ifndef RTW_HEADER_state_h_
#define RTW_HEADER_state_h_
#include <string.h>
#ifndef state_COMMON_INCLUDES_
#define state_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#define state_rtModel                  RT_MODEL_state_T
...
typedef struct {
  ...
  real_T StateSpace1_CSTATE[4];        /* '<Root>/State-Space1' */
...
typedef struct {
  ...
  boolean_T StateSpace1_CSTATE[4];     /* '<Root>/State-Space1' */
...
typedef struct {
   ...
   */
  real_T StateSpace1_rtw_collapsed_sub_expr_10[16];

  /* Expression: A_up-L_up*C
   * Referenced by: '<Root>/State-Space'
   */
  real_T StateSpace_rtw_collapsed_sub_expr_6[16];
} ConstP_state_T;

/* Backward compatible GRT Identifiers */
#define rtB                            state_B
#define BlockIO                        B_state_T
#define rtX                            state_X
#define ContinuousStates               X_state_T
#define rtXdot                         state_XDot
#define StateDerivatives               XDot_state_T
#define tXdis                          state_XDis
#define StateDisabled                  XDis_state_T
#define rtP                            state_P
#define Parameters                     P_state_T
#define rtDWork                        state_DW
#define D_Work                         DW_state_T
#define ConstParam                     ConstP_state_T
#define rtcP                           state_ConstP

/* Parameters (default storage) */
struct P_state_T_ {
  real_T A_down[16];                   /* Variable: A_down
                                        * Referenced by: '<Root>/State-Space1'
                                        */
  real_T A_up[16];                     /* Variable: A_up
                                        * Referenced by: '<Root>/State-Space'
                                        */
  real_T K_I_down;                     /* Variable: K_I_down
                                        * Referenced by: '<Root>/Gain3'
                                        */
  real_T K_I_up;                       /* Variable: K_I_up
                                        * Referenced by: '<Root>/Gain2'
                                        */
  real_T K_new_down[4];                /* Variable: K_new_down
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T K_new_up[4];                  /* Variable: K_new_up
  ...
  real_T Integrator1_IC;               /* Expression: 0
                                        ...
                                        */
  real_T StateSpace_B[12];             /* Expression: [B_up, L_up]
                                        * Referenced by: '<Root>/State-Space'
                                        */
  ...
  real_T StateSpace_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<Root>/State-Space'
                                        */
  real_T StateSpace1_B[12];            /* Expression: [B_down, L_down]
                                        * Referenced by: '<Root>/State-Space1'
                                        */
  real_T StateSpace1_C[16];            /* Expression: eye(4)
                                        * Referenced by: '<Root>/State-Space1'
                                        */
...
extern P_state_T state_P;

/* Block signals (default storage) */
extern B_state_T state_B;

/* Continuous states (default storage) */
extern X_state_T state_X;

/* Block states (default storage) */
extern DW_state_T state_DW;
...
extern void state_output0(void);
extern void state_update0(void);
extern void state_output2(void);
extern void state_update2(void);
extern void state_output(int_T tid);
extern void state_update(int_T tid);
extern void state_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern state_rtModel *state(void);
...
extern RT_MODEL_state_T *const state_M;
 ...
 *
 * '<Root>' : 'state'
 * '<S1>'   : 'state/Pendulum P1'
 */
#endif                                 /* RTW_HEADER_state_h_ */
