...
MODEL                := state
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c state_data.c state_tgtconn.c
MAKEFILE             := state.mk
...
# additional includes
REQ_INCLUDES += ;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask/state_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
