...
# additional includes
REQ_INCLUDES += ;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask/LinearPendulum;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask/LinearPendulum/P1K23_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
