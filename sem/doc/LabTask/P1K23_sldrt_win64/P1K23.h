...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* P1K23_COMMON_INCLUDES_ */

#include "P1K23_types.h"
...
#define P1K23_rtModel                  RT_MODEL_P1K23_T
...
#define rtB                            P1K23_B
#define BlockIO                        B_P1K23_T
#define rtX                            P1K23_X
#define ContinuousStates               X_P1K23_T
#define rtXdot                         P1K23_XDot
#define StateDerivatives               XDot_P1K23_T
#define tXdis                          P1K23_XDis
#define StateDisabled                  XDis_P1K23_T
#define rtP                            P1K23_P
#define Parameters                     P_P1K23_T
#define rtDWork                        P1K23_DW
#define D_Work                         DW_P1K23_T
...
extern P_P1K23_T P1K23_P;

/* Block signals (default storage) */
extern B_P1K23_T P1K23_B;

/* Continuous states (default storage) */
extern X_P1K23_T P1K23_X;

/* Block states (default storage) */
extern DW_P1K23_T P1K23_DW;
...
extern void P1K23_initialize(void);
extern void P1K23_output0(void);
extern void P1K23_update0(void);
extern void P1K23_output2(void);
extern void P1K23_update2(void);
extern void P1K23_output(int_T tid);
extern void P1K23_update(int_T tid);
extern void P1K23_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern P1K23_rtModel *P1K23(void);
...
extern RT_MODEL_P1K23_T *const P1K23_M;
