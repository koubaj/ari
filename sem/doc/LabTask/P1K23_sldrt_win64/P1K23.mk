...
MODEL                := P1K23
MODULES              := P1K23_data.c P1K23_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := P1K23.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := P1K23_ref.rsp
...
# additional includes
REQ_INCLUDES += ;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask;//aspace.msad.fel.cvut.cz/users$/koubajac/Desktop/LabTask/P1K23_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
