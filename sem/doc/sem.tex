...
ignál v rozsahu $u \in [-10; 10]$.  Dále jsem zjistil hodnotu deadzone - vozík
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/deadzone.png}
...
nestabilní (obsahuje jeden pól v bodě $10.56$).
...
odlatit pomocí programu \texttt{rltool} (vkládám systém se záporným znaménkem),
pro D regulátor umístím jednu nulu do bodu 0 a budu hýbat s póly, dokud nezískám
otpimální regulátor na obrázku~\ref{fig:rltool_phi}.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_simulink.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_phi_old.png}
  \caption{Úhel kyvadla s neodladěnými póly}\label{fig:state_prefilter_phi_old}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_x.png}
  \caption{Poloha vozíku se stavovou zpětnou vazbou}\label{fig:state_prefilter_x}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_phi_new.png}
...
poloze s minimalní změnou úhlu a zároveň co nejdříve dojelo na stanovenou
pozici. Výsledky jsou na obrázcích~\ref{fig:state_prefilter_up_x}
a~\ref{fig:state_prefilter_up_phi}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_up_x.png}
  \caption{}\label{fig:state_prefilter_up_x}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_up_phi.png}
  \caption{}\label{fig:state_prefilter_up_phi}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_prefilter_x_disorder.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/state_integral_simulink.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/observer_simulink.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{img/observer_test.png}
...
$l=1.1$
$T = 10.07-9.45 = 0.62$
$\omega = \frac{2\pi}{T} = 10.134$
$J = \frac{mg\frac{l}{2}}{\omega^2} = 0.0014$

$A = \frac{1}{5}\mathrm{ln}\left(\frac{A_1}{A_5}\right) = \frac{1}{5}\mathrm{ln}\left(\frac{1.655}{1.215}\right) = 0.174$
