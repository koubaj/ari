...
skok. Pro lepší řízení mohu ovšem target postupně načítat a tím se vyhnout
zbytečně velkému překmitu. Za target připojím přenos druhé stupně, jehož hodnoty
odladím a dostanu tak efektivnější řízení vozíku. Pro přenos $\frac{1}{0.05s^2 +
s + 1}$ dostávám překmit $5 \%$, v rozmezí $\pm 5 \%$ od cílové hodnoty bude
vozík za $2.6 \mathrm{s}$. Graf je na obrázku~\ref{fig:reference_model}. 
