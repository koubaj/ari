...
Pro vstupní napětí je v programu uvedena saturace: vozík bude přijímat signál v rozsahu $[-10; 10]$. 
Dále znám i hodnotu deadzone - vozík nereaguje na napětí $\mathrm{abs}(u)\leq0.2$.

\section{Linearizace}
Pro účely úlohy potřebuji získat linearizované rovnice kyvadla pro $\varphi = -90$° (kyvadlo míří kolmo dolů) 
a pro $\varphi = 90$° (kyvadlo míří kolmo nahoru). Linearizaci provedu pomocí Matlabu:
