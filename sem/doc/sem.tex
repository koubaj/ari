...
a dvěma výstupy:
\begin{itemize}
  \item úhel natočení kyvadla měřený od vodorovné polohy $\varphi$ [$^\circ$],
...
pro $\varphi = -90^\circ$ (kyvadlo míří kolmo dolů) a pro $\varphi = 90^\circ$ (kyvadlo
...
\subsection{Reakce lineárního a nelineárního systému na vstupy}
...
\begin{figure}[htbp]
  ...
  \caption{Poloha vozíku s posicastem}\label{fig:posicast_x}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{img/posicast_phi.png}
  \caption{Úhel kyvadla s posicastem}\label{fig:posicast_phi}
\end{figure}
